  ...
  <div className="flex flex-wrap gap-3 justify-center items-center mt-4">
    {loggedInEmail === email && (
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900 text-white rounded-full shadow-md hover:shadow-red-700 transition-all"
      >
        <Trash2 size={18} />
        Delete
      </button>
    ...
    <button
      onClick={onClick}
      className="px-4 py-2 bg-gradient-to-r from-cyan-400 to-cyan-600 text-white rounded-full font-semibold shadow hover:shadow-cyan-500 transition-all"
    >
      👁️ View
    </button>
